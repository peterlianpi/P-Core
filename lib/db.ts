...
import { featuresDBPrismaClient } from "./prisma-client/features-prisma-client";
...
// Re-export features database client
export const featuresDb = featuresDBPrismaClient;
