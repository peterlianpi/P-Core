...
// Define colors in chartConfig for each khawkName
...
export function BarHomeKhawkChart({ data }: HomeKhawkChartProps) {
        ...
        <ChartContainer config={chartConfig}>
          ...
          >
            ...
            <YAxis
              ...
              tickMargin={10}
              axisLine={false}
              tickFormatter={(value) => value.slice(0, 3)} // Shows first 3 letters of the khawkName
              hide
            />
