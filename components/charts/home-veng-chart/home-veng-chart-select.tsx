...
import { PieHomeVengChart } from "./pie-home-veng-chart";
import { BarHomeVengChart } from "./bar-home-veng-chart";

type Props ={
  data: { vengName: string; totalHomes: number }[] | undefined;
  totalHomes? : number;
}

const HomeVengChartSelector = ({
  data,
  totalHomes 
}:Props) => {
    ...
    <div className="grid gap-6">
      <div className="col-span-1 lg:col-span-2">
        ...
        {selectedChart === "chartPage" && data && (
          <BarHomeVengChart data={data} />
        )}
        {selectedChart === "pieChart" && data && (
          <PieHomeVengChart data={data} totalHomes={totalHomes} />
        )}
      </div>
    </div>
  );
...
export default HomeVengChartSelector;
