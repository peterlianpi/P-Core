...
import { UserIcon, Shield, Building2, MessageCircle, Camera, Eye, EyeOff, Loader2, Menu } from "lucide-react"
                    ...
                    <div className="md:hidden flex flex-col items-center gap-4 pb-4 border-b">
                      <div className="relative">
                        ...
                        <Button
                          size="icon"
                          variant="outline"
                          className="absolute -bottom-1 -right-1 h-7 w-7 rounded-full bg-transparent"
                        >
